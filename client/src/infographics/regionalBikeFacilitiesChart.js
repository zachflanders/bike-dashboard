        ...
        var chartData = d3.nest()
         ...
         var z = d3.scaleOrdinal().range(["#2980b9", "#27ae60", "#8e44ad"]);
          ...
          var chartData = d3.nest()
            ...
            x.domain([0, d3.max(chartData, function(d) { console.log(d); return d3.max(keys, function(key1) { return d.value[key1]; })})]).nice();
            y0.domain(chartData.map(function(d) { console.log(d.key); return d.key; }));
